...
class _BannerState extends State<DisplayBanner> {
  ...
  Widget build(BuildContext context) {
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                    ...
                    image: DecorationImage(
                        ...
                        fit: BoxFit.cover,
                        image: NetworkImage(_final_banner_list[index].image))),
                child: Stack(
                  children: <Widget>[
                    Container(
                      ...
                      child: PopupMenuButton<String>(
                        ...
                        onSelected: (value){
                         ...
                         // print("Valueeeeeeeeeeeeeeeeeeeee  ${value}");
                          ...
                          _popUpMenuAction(value,_final_banner_list[index]);
    ...
    ) : AddBanner(/*key: DisplayBanner().key ,chnagePage: changePage(),*/);
  }
  ...
  void _popUpMenuAction(String value,MBanner mBanner) {
    ...
    if(value=="Delete"){
      ...
      FirebaseDatabase.instance.reference().child(Common.banner).child(mBanner.id).remove().then((_){
